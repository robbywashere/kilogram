...
const _accessor = ()=> ((typeof LOG_LEVEL !== "undefined") ? LOG_LEVEL : config.get('LOG_LEVEL'));
...
module.exports = { getLogLevel: _accessor, setLogLevel: (level)=> { LOG_LEVEL = level }, logger: makeLogger(), makeLogger, levels: { LOG: 4, DEBUG: 3, STATUS:2, ERROR: 1, NONE: 0 } }
