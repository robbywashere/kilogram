...
module.exports = { getLogLevel: ()=> config.get('LOG_LEVEL'), setLogLevel: (level)=> { config.LOG_LEVEL = level }, logger: makeLogger(), makeLogger, levels: { LOG: 4, DEBUG: 3, STATUS:2, ERROR: 1, NONE: 0 } }
